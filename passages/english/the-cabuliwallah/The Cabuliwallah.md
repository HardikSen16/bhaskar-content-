...
reflection_prompts:
  ...
  - "What does Mini's initial fear of the Cabuliwallah reveal about her understanding of the world?"
  - "Discuss the cultural and social context implied by the interaction between Mini and the Cabuliwallah."
student_intro: "This passage is the beginning of a short story by Rabindranath Tagore, a Nobel laureate from India. It introduces a young girl named Mini, known for her incessant talking, and her father, who cherishes her liveliness. The story takes an interesting turn when Mini encounters a street vendor, a 'Cabuliwallah,' for the first time, leading to a memorable interaction that highlights childhood fears and burgeoning curiosity."
vocabulary:
  - term: "chattering"
    meaning: "talking rapidly and continuously."
    example: "The children's chattering filled the playground."
  - term: "vexed"
  ...
  - term: "prattle"
    ...
    example: "The baby's prattle was endearing to her parents."
  - term: "embarked"
    meaning: "began a course of action, especially one that is important or demanding."
    example: "He embarked on a new career after leaving university."
  - term: "tide"
    meaning: "a strong current or flow of something."
    example: "She was swept away by the tide of public opinion."
  - term: "anew"
    meaning: "again; from the beginning."
    example: "He started his life anew in a different city."
  - term: "contrived"
    meaning: "created or arranged in a way that seems artificial and unrealistic."
    example: "His smile looked contrived, not genuine."
  - term: "overlooked"
    meaning: "had a view of from above."
    example: "The hotel room overlooked the sea."
  - term: "soiled"
    meaning: "made dirty or stained."
    example: "He wore a soiled shirt that needed washing."
  - term: "turban"
    meaning: "a long piece of cloth wound round the head, worn by men in some Asian and African countries."
    example: "The man wore a brightly colored turban."
  - term: "pedlar"
    meaning: "a person who travels from place to place selling small articles."
    example: "The pedlar offered trinkets and small goods."
  - term: "precarious"
    meaning: "not securely held or in position; dangerously likely to fall or collapse."
    example: "The climber was in a precarious position on the cliff face."
  - term: "burgeoning"
    meaning: "beginning to grow or increase rapidly; flourishing."
    example: "The burgeoning city attracted many new residents."
scholarly_notes:
  - heading: "Rabindranath Tagore"
    body: "Rabindranath Tagore (1861-1941) was a Bengali poet, writer, playwright, composer, philosopher, social reformer, and painter. He was awarded the Nobel Prize in Literature in 1913 for his profoundly sensitive, fresh and beautiful verse, by which, with consummate skill, he has made his poetic thought, expressed in his own English words, a part of the literature of the West. 'The Cabuliwallah' is one of his most famous short stories."
  - heading: "Cabuliwallah"
    body: "A 'Cabuliwallah' (or Kabuliwala) was a term historically used in colonial India to refer to vendors, typically Pashtun men from Afghanistan, who travelled to India selling goods like fruits, nuts, and carpets. They were often seen as outsiders and sometimes viewed with suspicion by locals, as hinted at by Mini's fear."
  - heading: "Frontier Policy"
    body: "The mention of 'Frontier Policy' likely refers to the British colonial government's policies concerning the North-West Frontier (modern-day Pakistan and Afghanistan). This region was strategically important and often a source of political and military tension between British India and Afghanistan."
---
