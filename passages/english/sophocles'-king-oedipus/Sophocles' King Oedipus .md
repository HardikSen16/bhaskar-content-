---
title: "Sophocles' King Oedipus"
titleEn: "Sophocles' King Oedipus"
...
reflection_prompts:
  ...
  - "How does the dialogue between Oedipus and the Priest establish the central conflict and the mood of the play?"
  - "Consider the themes of fate, free will, and divine intervention as presented in this excerpt. How do they interact?"
student_intro: "This passage is an excerpt from William Butler Yeats's translation of Sophocles' famous Greek tragedy, 'Oedipus Rex' (King Oedipus). It depicts the desperate plea of the citizens of Thebes to their king, Oedipus, to save them from a devastating plague. The dialogue sets the stage for Oedipus's fateful quest to uncover the truth behind the city's suffering."
vocabulary:
  - term: "suppliants"
    meaning: "People who ask for something humbly and earnestly, often in prayer or petition."
    example: "The villagers were suppliants to the king, begging for relief from the drought."
  - term: "blight"
    meaning: "A disease that destroys or causes parts of a plant to die."
    example: "A sudden blight swept through the orchards, ruining the apple harvest."
  - term: "lamentation"
    meaning: "A passionate expression of grief or sorrow."
    example: "The funeral was filled with the lamentation of the deceased's family."
  - term: "Pythian House of Phoebus"
    meaning: "The Oracle of Delphi, dedicated to the god Apollo (Phoebus)."
    example: "The king sent a messenger to the Pythian House of Phoebus to seek guidance."
  - term: "oracle"
    meaning: "A priest or priestess acting as a medium through whom advice or prophecy was sought from a deity in classical antiquity."
    example: "The oracle's cryptic words sent the hero on a perilous quest."
  - term: "purification"
    meaning: "The process of making something pure or free from contamination."
    example: "The ritual purification was necessary before entering the sacred temple."
  - term: "avenger"
    meaning: "A person who seeks to harm or punish someone in return for an injury or wrong."
    example: "He vowed to be the avenger of his father's death."
scholarly_notes:
  - heading: "Sophocles and Greek Tragedy"
    body: "Sophocles (c. 497/496 – 406/405 BC) was one of the three great ancient Greek tragedians. 'Oedipus Rex' is considered one of his masterpieces, exploring themes of fate, free will, and the tragic consequences of hubris and ignorance."
  - heading: "Thebes and Cadmus"
    body: "Thebes was a major city in ancient Greece, founded, according to myth, by Cadmus, who sowed dragon's teeth that sprang up as armed warriors. The city is central to many Greek myths, including those of Oedipus, Dionysus, and Heracles."
  - heading: "The Sphinx"
    body: "In Greek mythology, the Sphinx was a monstrous creature with the head of a human, the body of a lion, and the wings of a bird. She terrorized Thebes by posing a riddle, killing those who could not answer. Oedipus famously solved her riddle, leading to her destruction."
  - heading: "The Oracle of Delphi"
    body: "The Oracle of Delphi, located at the sanctuary of Apollo on Mount Parnassus, was the most important oracle in the ancient Greek world. Its pronouncements, delivered by the Pythia, were believed to be the direct words of Apollo and were sought by individuals and states for guidance on crucial matters."
---
