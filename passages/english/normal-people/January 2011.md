...
reflection_prompts:
  ...
  - "Discuss the dynamic between Marianne and Connell. Despite their outward pretense of not knowing each other at school, what hints are there of their deeper connection?"
  - "Analyze Marianne's character. How does her intelligence, social isolation, and family background shape her behavior and her relationship with Connell?"
student_intro: "This passage from Sally Rooney's 'Normal People' introduces us to Marianne and Connell, two high school students from different social backgrounds. As they interact in Marianne's home, the text subtly reveals the complexities of their relationship, the unspoken tensions of class, and their individual struggles with social acceptance."
vocabulary:
  - term: "mock results"
    meaning: "practice or preliminary examination results, used to gauge performance before official exams."
    example: "Students were anxious to see their mock results before the final exams."
  - term: "suppresses"
    meaning: "to forcibly put an end to; to restrain or prevent."
    example: "He suppresses a yawn during the long lecture."
  - term: "audible"
    meaning: "able to be heard."
    example: "Her sigh was barely audible, but he heard it."
  - term: "affect"
    meaning: "to pretend to have or feel something."
    example: "They affect an air of indifference, but are actually very concerned."
  - term: "contempt"
    meaning: "the feeling that a person or a thing is beneath consideration, worthless, or deserving scorn."
    example: "She regarded his rude behavior with open contempt."
scholarly_notes:
  - heading: "Social Class in Rooney's Work"
    body: "Sally Rooney frequently explores the impact of social class on relationships and individual identity. In this passage, the contrast between Marianne's affluent home and Connell's mother's profession highlights the subtle and overt ways class differences manifest, influencing the characters' perceptions and interactions."
  - heading: "The 'Normal People' Dynamic"
    body: "The novel 'Normal People' (from which this passage is likely excerpted) delves into the intimate and often fraught relationship between Connell and Marianne. Their connection is marked by intellectual intimacy, emotional vulnerability, and the external pressures of their social environments, creating a compelling study of young love and belonging."
---
